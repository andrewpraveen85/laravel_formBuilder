@extends('layouts.app_dashboard_edit')
            ...
            <div class="col-sm-6 col-md-6">
                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <input type="hidden" name="" id="id" value="<?= $form->id; ?>" placeholder="placeholder" class="form-control">
                                <input type="hidden" name="" id="user_id" value="<?= auth()->user()->id; ?>" placeholder="placeholder" class="form-control">
                                <button type="button" class="btn btn-primary" id="update_form">Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
